...
Reads all Excel files matching the pattern:
    curr_stay_booking_by_stay_date test environment vs PROD existing (*stay_id *).xlsx
...
FILE_PATTERN     = "curr_stay_booking_by_stay_date test environment vs PROD existing (*stay_id *).xlsx"
...
def main():
    file_dir    = r'C:\Users\jwalker221\OneDrive - Hilton\Jira\Stay Derived\curr_stay_booking_by_stay_date'
    output_path = r'C:\Users\jwalker221\OneDrive - Hilton\Jira\Stay Derived\curr_stay_booking_by_stay_date\curr_stay_booking_by_stay_date test environment vs PROD existing summary results.xlsx'
