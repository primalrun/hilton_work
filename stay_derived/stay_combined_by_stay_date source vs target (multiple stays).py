...
file_sql_validation_name = 'S2T validation dynamic.sql'
file_sql_random_stay_name = 'random stay_id S2T that exists in target.sql'
...
for elem in prop_and_stay:
    ...
    non_variance_column = ['row_source', 'sort_stay_id', 'sort_stay_dt']
