...
Reads all Excel files matching the pattern:
    orig_stay_booking_by_stay_date test environment vs PROD existing (*stay_id *).xlsx
...
FILE_PATTERN     = "orig_stay_booking_by_stay_date test environment vs PROD existing (*stay_id *).xlsx"
...
def main():
    ...
    output_path = r'C:\Users\jwalker221\OneDrive - Hilton\Jira\Stay Derived\orig_stay_booking_by_stay_date\orig_stay_booking_by_stay_date test environment vs PROD existing summary results.xlsx'
